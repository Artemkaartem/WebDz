...
$work = [
  ...
  'work_name' => 'Менеджер', 
  'work_dataStart' => '2020',
  'work_dataEnd' => 'настоящее время',
  'work_desc' => 'Продажа товаров',
  ],
  [
  'work_name' => 'Менеджер', 
  'work_dataStart' => '2015',
  ...
  'work_dataStart' => '2022',
  'work_dataEnd' => 'настоящее время',
  'work_desc' => 'Будущее место работы',
  ],
];
?>
        ...
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          <h2 class="w3-text-grey w3-padding-16"><i
           ...
           <?php for ($i=0; $i < count($work); $i++):?>     
            <div class="w3-container">          
             <h5 class="w3-opacity"><b><?php echo $work[$i]['work_name']?></b></h5>
             <h6 class="w3-text-teal">
              <i class="fa fa-calendar fa-fw w3-margin-right"></i>
              <?php echo $work[$i]['work_dataStart'];?> -
              <?php if ($i == 0):?>
               <span class="w3-tag w3-teal w3-round">
                <?php echo $work[$i]['work_dataEnd'];?>
               </span>
              <?php else: ?>
               <?php echo $work[$i]['work_dataEnd'];?>
              <?php endif; ?>
             </h6>
            <p><?php echo $work[$i]['work_desc']?></p>             
            <hr>          
          </div>   
          <?php endfor; ?>  
        </div>
